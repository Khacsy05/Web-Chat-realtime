...
import { register,login, sendOtp, verifyOtp, resetPass, me, updateProfile, changePassword } from "../controller/AuthController.js";
...
routerAuth.put("/changePassword",authMiddleware,changePassword)
